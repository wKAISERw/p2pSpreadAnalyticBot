...
_DISPLAY_LABELS = {
    ...
    "show_ai_thoughts": "🔘 Хід думок AI (спойлер)",
...
_DISPLAY_DESCRIPTIONS = {
    ...
    "show_ai_thoughts": "Повний ланцюжок міркувань моделі: умови → відгуки → поведінка → висновок. Довгий, тому вимкнений за замовчуванням.",
