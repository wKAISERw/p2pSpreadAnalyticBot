...
class Order:
    ...
    # Ключі сигналів, які спрацювали на цьому ордері. Персональна
    # політика застосовується саме до них: `risk_flag` — рядок для
    # показу, а не структура для рішень.
    risk_signals: list[str] = field(default_factory=list)
    # Тексти негативних відгуків — рівно стільки, скільки треба, щоб
    # персональне правило на кшталт «ховати, якщо у відгуках є „кинув“»
    # мало на чому спрацювати. Спільний прохід движка чужих правил не
    # знає, тож текст мусить дожити до моменту рішення.
