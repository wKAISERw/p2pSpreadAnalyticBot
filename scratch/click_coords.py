...
async def main():
    ...
    async with async_playwright() as p:
        ...
        print("Clicking at coordinates x=1205, y=435...")
        await page.mouse.click(1205, 435)
        await page.wait_for_timeout(3000)
        
        # Capture screenshot
        screenshot_path = "C:\\Users\\user\\.gemini\\antigravity\\brain\\8429dec0-2c12-45da-8137-3f456255efe1\\binance_detail_coords_clicked.png"
