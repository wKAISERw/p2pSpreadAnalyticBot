  ...
  return (
    ...
    >
      ...
      {/*
        ...
        Коробка розпірки має збігатися з коробкою картки до пікселя:
        p-6 і border тут не декорація, а саме те, що вона міряє. Без них
        стос виходив на ~50px коротшим за вміст, і низ картки вилазив за
        контейнер — на мобільному це було видно як зрізаний край.
      */}
      <div className="invisible rounded-3xl p-6 border" aria-hidden>
        <Card frame={FRAMES[0]} />
      </div>
